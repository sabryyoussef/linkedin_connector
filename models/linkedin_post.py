...
class LinkedinPost(models.Model):
    ...
    def _linkedin_register_upload_image(self, attachment):
        ...
        """
        self.ensure_one()
        owner = self.account_id.linkedin_member_urn
        if not owner:
            raise UserError(_("LinkedIn member URN is missing. Reconnect the LinkedIn account."))
    ...
    def _build_post_payload(self, media_asset_urns=None):
        self.ensure_one()
        author = self.account_id.linkedin_member_urn
